...
<template>
  <div class="dashboard">
    ...
    <div class="shortcuts">
      ...
      <a v-if="auth.isPrestataire" href="/carte" class="shortcut-card">
        <div class="shortcut-icon">
        ...
        <span class="shortcut-label">Carte</span>
        <span class="shortcut-desc">Voir ma position sur la carte</span>
        <span class="shortcut-arrow">→</span>
      </a>
      <a href="/app/parametres" class="shortcut-card">
        <div class="shortcut-icon">
        ...
        <span class="shortcut-desc">Compte, CGU, suppression</span>
        <span class="shortcut-arrow">→</span>
      </a>
      <template v-if="auth.isStaff">
        ...
        <a href="/app/admin/reviews" class="shortcut-card shortcut-card--admin">
          <div class="shortcut-icon">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>
          </div>
          <span class="shortcut-label">Avis en attente</span>
          <span class="shortcut-desc">Modérer les avis clients</span>
          <span class="shortcut-arrow">→</span>
        </a>
      </template>
    </div>
